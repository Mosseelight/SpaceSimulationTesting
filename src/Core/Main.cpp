...
int main()
{
    ...
    mainScene.AddSpatialObject(CreateSphereMesh(glm::vec3(1,0.5f,1), glm::vec3(0,0,0), 3));
    mainScene.AddSpatialObject(CreateSphereMesh(glm::vec3(0.5f,1,1), glm::vec3(0,0,0), 3));
